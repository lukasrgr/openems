...
import { ServiceComponent as EdgeSettingsServiceComponent } from './edge/settings/service/service.component';
...
const routes: Routes = [
  ...
  { path: 'device/:edgeId/settings/service', component: EdgeSettingsServiceComponent },
